...
import com.start.base.presentation.common.ErrorHandler
...
abstract class BaseViewModel : ViewModel() {
    ...
    val showErrorEvent = MutableSharedFlow<ContentError>(extraBufferCapacity = 1)
